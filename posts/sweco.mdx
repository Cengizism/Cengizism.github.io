---
title: Sweco
description: "At Sweco, I contributed to the redesign and redevelopment of a core GIS software product within a web application built with ReactJS, Twitter Bootstrap, and OpenLayers. I conducted extensive research to define requirements, facilitated sessions to map user journeys, and developed wireframes and interactive prototypes. My role also included frontend development, integrating custom UI widgets and components, and enhancing user interface elements."
date: 2022
---
...
##### **Company**  
Sweco Nederland - Rotterdam, Netherlands
##### **Role**  
