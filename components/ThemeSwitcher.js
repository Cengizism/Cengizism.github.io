  ...
  return (
    <div className="flex p-0.5 bg-white dark:bg-slate-600 border border-slate-600 fixed top-2 right-2">
      <button
        ...
        className="flex items-center justify-center align-center p-2 w-9 h-9 bg-opacity-10 hover:bg-opacity-50 dark:bg-black transition"
      >
        {moonIcon}
      </button>
      ...
      <button
        ...
        className="flex items-center justify-center align-center p-2 w-9 h-9 bg-slate-600 dark:bg-opacity-30 dark:hover:bg-opacity-50 transition"
      >
        {sunIcon}
      </button>
    </div>
